...
repairCfg = {
	...
	fixMessages = {
		"Puneți din nou dopul de ulei",
		"Ai oprit scurgerea de ulei folosind gumă de mestecat",
		"Ai reparat tubul de ulei cu bandă adezivă",
		"Ați strâns șurubul vasului de ulei și ați oprit scurgerea",
		"Ați dat cu piciorul motorului și a revenit magic la viață",
		"Ai scos puțină rugină din tubul scânteii",
		"Ai țipat la vehiculul tău și a avut cumva un efect"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Ai verificat dopul de ulei. Este încă acolo",
		"Te-ai uitat la motor, mi s-a părut bine",
		"Te-ai asigurat că banda de prindere încă ținea motorul împreună",
		"Ai mărit volumul radioului. Doar a înecat zgomotele ciudate ale motorului",
		"Ați adăugat antifurt la tubul scânteii. Nu a făcut nicio diferență",
		"Nu repara niciodată ceva care nu este stricat, au spus ei. Nu ai ascultat. Cel puțin nu s-a înrăutățit"
	},
	noFixMessageCount = 6
}
